        ...
        <header>
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center">
                    <img src={MyPhoto} className="h-8 mr-3 rounded-full" alt="Shikhar's Photo" />
                ...
                <ul className="font-medium flex flex-col p-3 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <div className='flex gap-2 bg-gray-800 bg-opacity-60 border border-gray-300 text-gray-50 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5'>
                            <div>
                               <a className='text-white' href="https://www.linkedin.com/in/shikhar-mishra-17b5a1231/">
                            ...
                            <div>
                                <a className='text-white' href="https://github.com/shikharmishra1/">
                            ...
                            <div>
                                <a className='text-white' href="https://www.instagram.com/driedonought">
                            ...
                            <div>
                                <a className='text-white' href=" twitter is a cesspool so I don't use it sorry😔">
